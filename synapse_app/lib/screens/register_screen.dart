...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void _handleRegister() async {
    ...
    if (success) {
      // FIX: Langsung navigate, tidak ada kode apapun yang jalan setelah ini
      // karena pushReplacement memang mengganti screen, bukan menghentikan fungsi.
      // SnackBar sukses ditampilkan SEBELUM navigate agar sempat terlihat.
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Registrasi sukses! Silakan cek email Anda.'),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    // Form NIM & Kelas (khusus mahasiswa)
                    if (_isMahasiswa) ...[
                      Row(
                        children: [
                          Expanded(
                    ...
                    SizedBox(
                      ...
                      child: _isLoading
                          ...
                          : ElevatedButton(
                              ...
                              child: const Text('DAFTARKAN IDENTITAS',
                                  style: TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.bold,
                                      letterSpacing: 1)),
