...
class _QuizHistoryScreenState extends State<QuizHistoryScreen> {
  ...
  Future<void> _getAIAdvice(
      String quizId, String quizTitle, int score) async {
    showDialog(
      context: context,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Gagal meminta saran AI')));
      }
    } catch (e) {
      Navigator.pop(context);
          ...
          child: SingleChildScrollView(
            ...
            child: MarkdownBody(
              ...
              styleSheet: MarkdownStyleSheet(
                p: TextStyle(
                    color: Colors.blueGrey[800], fontSize: 15, height: 1.5),
                        ...
                        child: Row(
                          children: [
                            ...
                            ElevatedButton(
                              ...
                              onPressed: () {
                                _getAIAdvice(item['quiz_id'].toString(),
                                    item['title'] ?? 'Kuis', score);
                              },
                              child: const Row(
