...
<body>
    ...
    <div class="main">
        ...
        <!-- TOPBAR -->
        <a href="/pengaturan" style="display: flex; gap: 0px 8px; text-decoration:none; width:fit-content;">
        ...
        <div style="display: flex; flex-direction:column; align-items:center; width:100%; height:100%; padding-top:20px; gap: 10px;">
            <h1 style="color: #44474D; font-size: 40px; font-weight: 600;">Ubah Identitas</h1>
            ...
            <form action="#" method="POST" class="profile-card">
                ...
                <div class="profile-text" style="outline: solid 1px #44474D;">
                    ...
                    <input type="text" name="namaLengkap" placeholder="Nama Lengkap" class="profile-text-form">
                </div>
                ...
                <div class="profile-text" style="outline: solid 1px #44474D;">
                    ...
                    <a href="/pengaturan" class="button1" style="width: 100%;">UBAH IDENTITAS</a>
                </div>
            </form>
        </div>
    </div>
